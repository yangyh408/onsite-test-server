...
class ComfortCriteria:
    ...
    def penalty_for_vertical_a(self) -> None:
        ...
        if self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('E', 'W') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('W', 'E'):
        ...
        elif self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('N', 'S') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('S', 'N'):
            uncomfortable_a = self.info_table.ego_front_vehicle_info.loc[
            ...
            self.info_table.relation_judgement.info.replay_info['travel_direction']):
            if self.info_table.relation_judgement.info.replay_info['travel_direction'][0] == 'W' or \
                    self.info_table.relation_judgement.info.replay_info['travel_direction'][0] =='E':
                uncomfortable_a = self.info_table.ego_front_vehicle_info.loc[
                    self.info_table.ego_front_vehicle_info.loc[:, 'ay_ego'].astype('float') > 0.5, 'ay_ego']
                uncomfortable_d = self.info_table.ego_front_vehicle_info.loc[
                    self.info_table.ego_front_vehicle_info.loc[:, 'ay_ego'].astype('float') < -0.5, 'ay_ego']
                ...
                sum_d = sum(self.info_table.ego_front_vehicle_info.loc[
                    self.info_table.ego_front_vehicle_info.loc[:, 'ay_ego'].astype('float') < 0, 'ay_ego'].astype(
                    'float'))
            elif self.info_table.relation_judgement.info.replay_info['travel_direction'][0] == 'N' or \
                    self.info_table.relation_judgement.info.replay_info['travel_direction'][0] =='S':
                uncomfortable_a = self.info_table.ego_front_vehicle_info.loc[
                    self.info_table.ego_front_vehicle_info.loc[:, 'ax_ego'].astype('float') > 0.5, 'ax_ego']
                uncomfortable_d = self.info_table.ego_front_vehicle_info.loc[
                    self.info_table.ego_front_vehicle_info.loc[:, 'ax_ego'].astype('float') < -0.5, 'ax_ego']
            ...
            if self.info_table.relation_judgement.info.replay_info['travel_direction'][0] == 'W' or \
                    self.info_table.relation_judgement.info.replay_info['travel_direction'] [0]=='E':
                if self.info_table.relation_judgement.info.replay_info['target_travel_direction'] == ('W','E') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('E','W'):
                    uncomfortable_a = self.info_table.ego_front_vehicle_info.loc[
                        self.info_table.ego_front_vehicle_info.loc[:, 'ay_ego'].astype('float') > 0.5, 'ay_ego']
                    uncomfortable_d = self.info_table.ego_front_vehicle_info.loc[
                        self.info_table.ego_front_vehicle_info.loc[:, 'ay_ego'].astype('float') < -0.5, 'ay_ego']
                    ...
                    self.info_table.relation_judgement.info.replay_info['travel_direction'][0] =='S':
                if self.info_table.relation_judgement.info.replay_info['target_travel_direction'] == ('N', 'S') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] == ('S','N'):
                    uncomfortable_a = self.info_table.ego_front_vehicle_info.loc[
                        self.info_table.ego_front_vehicle_info.loc[:, 'ax_ego'].astype('float') > 0.5, 'ax_ego']
                    uncomfortable_d = self.info_table.ego_front_vehicle_info.loc[
                        self.info_table.ego_front_vehicle_info.loc[:, 'ax_ego'].astype('float') < -0.5, 'ax_ego']
                    ...
                    sum_d = sum(self.info_table.ego_front_vehicle_info.loc[
                        self.info_table.ego_front_vehicle_info.loc[:, 'ax_ego'].astype('float') < 0, 'ax_ego'].astype(
                        'float'))
        elif self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('E', 'N') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('E', 'S') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'N') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'S'):
            ...
            sum_d =sum(self.front_segment.loc[
                            self.front_segment.loc[:, 'ay_ego'].astype('float') < 0, 'ay_ego'].astype('float'))+sum(self.latter_segment.loc[
                            self.latter_segment.loc[:, 'ax_ego'].astype('float') < 0, 'ax_ego'].astype('float'))
        elif self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('N', 'W') or\
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('N', 'E') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('S', 'W') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('S', 'E'):
    ...
    def calculate_aax_and_aay(self) -> None:
        ...
        #print(self.front_segment['aay_ego'])
        return None
    ...
    def penalty_for_horizontal_aa(self) -> None:
        ...
        if self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('E', 'W') or \
            ...
            if self.info_table.relation_judgement.info.replay_info['travel_direction'][0] == 'W' or \
                ...
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('E', 'S') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'S') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'N'):
    ...
    def penalty_for_turning(self) -> None:
        mean_turn_a=0
        if not self.deducted_score:
            self.deducted_score = 0
        if self.info_table.relation_judgement.info.replay_info['travel_direction'] == ('N', 'W') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('N', 'E') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('S', 'W') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('S', 'E') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'N') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('W', 'S') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('E', 'N') or \
                self.info_table.relation_judgement.info.replay_info['travel_direction'] ==('E', 'S'):
            a_turning = self.middle_segment['ay_ego'].astype('float') * np.cos(
                self.middle_segment['yaw_ego'].astype('float')) - \
                        self.middle_segment['ax_ego'].astype('float') * np.sin(
                self.middle_segment['yaw_ego'].astype('float'))
            ...
            try:
                ...
                if self.info_table.relation_judgement.info.replay_info['target_travel_direction'] == ('N', 'W') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('N', 'E') or\
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('S', 'W') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('S', 'E') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('W', 'N') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('W', 'S') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('E', 'N') or \
                        self.info_table.relation_judgement.info.replay_info['target_travel_direction'] ==('E', 'S'):
                    a_turning = self.middle_segment['ay_ego'].astype('float') * np.cos(
                        self.middle_segment['yaw_ego'].astype('float')) - \
                                self.middle_segment['ax_ego'].astype('float') * np.sin(
                        self.middle_segment['yaw_ego'].astype('float'))
