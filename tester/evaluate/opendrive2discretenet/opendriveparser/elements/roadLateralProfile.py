...
from opendrive2discretenet.opendriveparser.elements.road_record import RoadRecord


class LateralProfile:
    """The lateral profile record contains a series of super elevation
    and cross fall records which define the
